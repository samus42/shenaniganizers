...
const TennisMinecraft = () => (
    <MemberCard name="TennisMinecraft" iconUrl='https://www.bungie.net//img/profile/avatars/cc000014.jpg'>
        <div className="member-detail">
            <div>Hey, is that Samus's kid, right?</div>
            <div><span style={{ fontStyle: 'italic' }}>The Warlock diving head first into twenty enemies with a shotgun? Yeah.</span></div>
            <div>That's unexpected, considering his dad.</div>
            <div><span style={{ fontStyle: 'italic' }}>Samus is his father, but Ace is his hero.</span></div>
            <div>Oh, that explains that strange thing I saw yesterday, then</div>
            <div><span style={{ fontStyle: 'italic' }}>What was that?</span></div>
            <div>Samus was just curled up in a ball, rocking back and forth and saying, "Two of them, I have <span style={{ fontWeight: 'bold' }}>two</span> of them now."</div>
        </div>
    </MemberCard>
)
