    ...
    stages: [
        {
            title: 'Security',
            description:
                'Both starting scanner and operator start on dark side. The designations are for where they go if we need a 2nd phase.',
            roles: [
        ...
        },
        {
            ...
            description:
                'Roles will shift base on broken augments. Active Supressor never picks up the bomb. Bomb teams are Scanners & Operators.',
            roles: [
                {name: 'Starting Operator', type: 'operator'},
        ...
        },
        {
            title: 'Taniks',
            description:
                'Roles will shift base on broken augments. Active Supressor & Operator never picks up the bomb. Bomb teams are Scanners, and the 2 other backups.',
            roles: [
                {name: 'Starting Operator', type: 'operator'},
                {name: 'Starting Scanner', type: 'scanner'},
