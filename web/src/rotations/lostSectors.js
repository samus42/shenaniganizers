...
const sector = (name, area, threat, shields, champions) => ({
    name,
    area,
    threat,
    shields,
...
const ChamberOfStarlight = sector(
...
const BayOfDrownedWishes = sector(
...
const TheBrokenDeep = sector(
    'The Broken Deep',
    Areas.PaleHeart,
    Strand,
    [Arc, Solar],
    [Unstoppable, Overload]
)
const TheBloomingDeep = sector(
    'The Blooming Deep',
    Areas.PaleHeart,
    Arc,
    [Arc, Solar],
...
*/
const rewardRotation = [Rewards.Arms, Rewards.Chest, Rewards.Head, Rewards.Legs]
