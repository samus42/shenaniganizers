import {getLostSector, Rewards} from './lostSectors'
import {Areas} from '../constants'

xdescribe('lost sector schedule', () => {
    it('starting day', () => {
        expect(getLostSector('2022-05-24')).toEqual({
    ...
    it('same sector as starting day, different reward', () => {
        expect(getLostSector('2022-06-04')).toEqual({
            name: 'K1 Crew Quarters',
            area: Areas.Moon,
            reward: Rewards.Arms
        })
    ...
    it('last in rotation', () => {
        expect(getLostSector('2022-06-03')).toEqual({
            name: 'The Quarry',
            area: Areas.EDZ,
            reward: Rewards.Legs
        })
