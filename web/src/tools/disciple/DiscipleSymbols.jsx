        ...
        <div className="main-tab-content">
            <div style={{display: 'flex', justifyContent: 'space-between'}}>
                ...
                <ToggleButtonGroup value={filter} exclusive onChange={changeFilter}>
                    <ToggleButton value={SymbolFilters.All}>All</ToggleButton>
                    <ToggleButton value={SymbolFilters.Rooms}>Rooms</ToggleButton>
                    <ToggleButton value={SymbolFilters.Obelisk}>Obelisk</ToggleButton>
                </ToggleButtonGroup>
            ...
            <SymbolGrid
                ...
                symbols={getFilteredSymbols(filter)}
