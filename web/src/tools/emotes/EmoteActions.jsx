...
function EmoteDisplay({value, label}) {
    ...
    return (
        <Box component="div" sx={{'& > img': {mr: 2, flexShrink: 0}, marginBottom: '20px'}}>
        ...
        <div style={{marginTop: '10px'}}>
            <FormControl fullWidth>
                ...
                >
                    ...
                    {showOption('up') && (
                        <MenuItem value="up">Up ({`${upEmote?.name || 'unassigned'}`})</MenuItem>
                    )}
                    {showOption('right') && (
                        <MenuItem value="right">
                            Right ({`${rightEmote?.name || 'unassigned'}`})
                        </MenuItem>
                    )}
                    {showOption('down') && (
                        <MenuItem value="down">
                            Down ({`${downEmote?.name || 'unassigned'}`})
                        </MenuItem>
                    )}
                </Select>
            </FormControl>
            ...
            <>
                ...
                <Grid container spacing={2}>
                    <Grid size={{xs:12, md:5}}>
                        ...
                        <EmoteDisplay
                            label="Yes, Ready, Go"
                            value={getEmoteByDirection(yesDirection)}
                        />
                        <EmoteDisplay
                            label="No, Wait, Stop"
                ...
                <Grid container spacing={2}>
                    <Grid size={{xs:12, md:5}}>
                        ...
                        <DirectionSelect
                            label="Yes, Ready, Go"
                            value={yesDirection}
                            onChange={setYesDirection}
                            leftEmote={leftEmote}
                            rightEmote={rightEmote}
                            downEmote={downEmote}
                            upEmote={upEmote}
                    ...
                    <Grid size={{xs:12, md:5}}>
                        ...
                        <DirectionSelect
                            label="3"
                            value={threeDirection}
                            onChange={setThreeDirection}
                            leftEmote={leftEmote}
                            rightEmote={rightEmote}
                            downEmote={downEmote}
                            upEmote={upEmote}
    ...
    return (
        <div style={{padding: '10px'}}>
            ...
            <div style={{marginBottom: '10px'}}>
                ...
                <Button sx={{marginLeft: '20px'}} variant="contained" onClick={onCancel}>
                    {canWrite ? 'Cancel' : 'Go Back'}
                </Button>
            </div>
